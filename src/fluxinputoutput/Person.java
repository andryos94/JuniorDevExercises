...
public class Person implements Serializable {
	...
	public Person(String firstName, String secondName, int birthYear, boolean isMarried, double netIncome) {
	...
	public String toString() {
		return "Person [firstName=" + firstName + ", secondName=" + secondName + ", birthYear=" + birthYear
				+ ", isMarried=" + isMarried + ", netIncome=" + netIncome + "]";
	}
}
